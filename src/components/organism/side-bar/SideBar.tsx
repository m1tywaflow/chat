...
export default function SideBar() {
  ...
  // Lightweight entrance: transform only, no opacity/fade.
  ...
  return (
    <>
      ...
      <section
        className={`w-full h-full flex flex-col border-r transition-colors duration-200 relative sidebar-enter ${entered ? "sidebar-entered" : ""}`}
        style={{
          background: theme.sideBarBg,
          borderColor: border,
          color: theme.text,
