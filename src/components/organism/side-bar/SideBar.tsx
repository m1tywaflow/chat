      ...
      >
        ...
        <div className="pb-3 pt-1">
          ...
          >
            ...
            >
              <UserCircle size={16} style={{ color: accent }} />
            </div>
            <span className="text-sm font-semibold">Your profile</span>
          </button>
        </div>

        {/* collapse toggle — floating bottom-right, matches reference */}
        <button
          title="Collapse sidebar"
          className="absolute bottom-3 right-4 w-9 h-9 rounded-full flex items-center justify-center cursor-pointer transition-colors"
