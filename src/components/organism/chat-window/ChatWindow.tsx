...
//                   />
//                 ) : (
//                   <div className="w-20 h-20 rounded-full   from-[#A78BFA] to-[#60A5FA] border-4 border-[#0F1620] flex items-center justify-center text-white text-2xl font-bold">
...
//             className="text-sm font-semibold text-white/80 tracking-wide hover:text-white transition-colors cursor-pointer"
//           >
//             {otherUser?.username ?? "..."}
//           </button>
