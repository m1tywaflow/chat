...
export default function ChatWindow() {
  ...
  return (
    <div className="flex flex-col w-full h-full min-h-0 bg-[#0B0F14] text-[#E5E7EB]">
      <div className="h-14 flex items-center justify-center border-b border-[#1F2A37] bg-[#0F1620] font-medium">
        Chat
      </div>
      <div className="flex-1 min-h-0 overflow-y-auto px-4 py-4 space-y-2">
        {messages.map((m) => {
          ...
          return (
            ...
            >
              <div
                className={`max-w-[70%] px-4 py-2 rounded-2xl text-sm font-bold break-words
                  ${
                    isMine
