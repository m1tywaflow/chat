  ...
  return (
    ...
    >
      <style>{`
        ...
        /* Fields — lit glass panes, same treatment as CreateChannelModal */
        .field-glass {
      ...
      >
        ...
        <div className={`relative rounded-2xl flex flex-col ${GLASS_PANEL}`}>
          <div className="flex items-center justify-between px-5 py-4 border-b border-white/[0.07]">
            <div className="flex items-center gap-2.5">
              <div className="w-7 h-7 rounded-lg bg-[#7c5cff]/[0.14] flex items-center justify-center">
            ...
            <button
              onClick={onClose}
              disabled={creating}
              className="w-7 h-7 flex items-center justify-center rounded-lg text-zinc-500 hover:text-white hover:bg-white/[0.07] transition-colors cursor-pointer disabled:opacity-30 disabled:cursor-not-allowed"
            >
              <X size={14} />
            </button>
          </div>
          ...
          <div className="px-5 pt-5 pb-5 flex flex-col gap-4">
            <div className="flex items-center gap-3.5">
              ...
              <div className="field-glass flex-1 min-w-0 relative rounded-xl h-11 flex items-center px-3.5">
                <input
                  ref={nameRef}
                  value={name}
                  ...
                  className="w-full bg-transparent text-[14px] font-medium text-white placeholder-white/25 outline-none pr-8"
                />
                {nameLen > 0 && (
                  <span className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[10px] text-white/20 tabular-nums pointer-events-none">
                    {nameLen}/40
                  </span>
                )}
              </div>
            </div>
            <div className="field-glass flex items-center gap-2.5 px-3.5 h-10 rounded-xl">
              ...
              />
              {selected.size > 0 && (
                <span className="shrink-0 text-[10.5px] font-semibold text-[#a996ff] tabular-nums whitespace-nowrap">
                ...
                <div className="cgm-chips flex items-center gap-1.5 -mx-1 px-1 overflow-x-auto">
                  {selectedContacts.map((c) => (
                    <button
                      ...
                      className="cgm-chip group shrink-0 flex items-center gap-1.5 pl-1 pr-2 py-1 rounded-full bg-white/[0.06] hover:bg-white/[0.1] transition-colors cursor-pointer"
                    >
              ...
              {filteredContacts.map((c, i) => {
                ...
                return (
                  <button
                    ...
                    className={`cgm-row flex items-center gap-2.5 px-2.5 py-2 rounded-xl transition-colors cursor-pointer text-left ${isSelected ? "bg-[#7c5cff]/[0.1]" : "hover:bg-white/[0.04]"
                      }`}
                  >
            ...
            <button
              ...
              disabled={!canCreate}
              className="submit-glow w-full h-11 rounded-xl text-[13.5px] font-semibold text-white transition-all disabled:opacity-30 disabled:cursor-not-allowed cursor-pointer bg-gradient-to-r from-[#7c5cff] to-[#5b3df0] hover:from-[#8d70ff] hover:to-[#6c4dff] active:scale-[0.98] flex items-center justify-center gap-2"
            >
              {creating ? (
                <>
