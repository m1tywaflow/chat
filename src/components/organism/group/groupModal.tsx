...
function ConfirmMini({
  ...
  return (
    <div
      className="fixed inset-0 z-[220] flex items-center justify-center bg-black/50 [backdrop-filter:blur(6px)] [-webkit-backdrop-filter:blur(6px)]"
      onClick={onCancel}
    >
      <div
        className={`w-80 rounded-2xl ${GLASS_PANEL} overflow-hidden`}
      ...
      >
        ...
        <div className="flex border-t border-white/[0.08]">
          <button
            onClick={onCancel}
            className="flex-1 py-3.5 text-sm text-zinc-400 hover:text-white hover:bg-white/[0.05] transition-colors font-medium border-r border-white/[0.08] cursor-pointer"
          >
            Cancel
          </button>
          ...
          <button
            onClick={onConfirm}
            className="flex-1 py-3.5 text-sm text-red-400 hover:text-red-300 hover:bg-red-500/[0.1] transition-colors font-semibold cursor-pointer"
          >
            {confirmLabel}
          </button>
        </div>
...
export default function GroupModal({ groupId, myUid, onClose }: Props) {
  ...
  return (
    <>
      ...
      <div
        className="fixed inset-0 z-[210] flex items-center justify-center bg-black/50 [backdrop-filter:blur(6px)] [-webkit-backdrop-filter:blur(6px)]"
        onClick={onClose}
      >
        <div
          className={`gm-modal w-[380px] max-h-[85vh] flex flex-col rounded-3xl ${GLASS_PANEL} overflow-hidden relative`}
          onClick={(e) => e.stopPropagation()}
        >
          ...
          {(inviteMode || settingsMode) && (
            <button
              ...
              className={`absolute top-3 left-3 z-20 w-8 h-8 flex items-center justify-center rounded-full ${GLASS_SURFACE} text-zinc-400 hover:text-white hover:bg-white/[0.1] transition-colors cursor-pointer`}
            >
              <ArrowLeft size={15} />
            </button>
          )}
          <button
            onClick={onClose}
            className={`absolute top-3 right-3 z-20 w-8 h-8 flex items-center justify-center rounded-full ${GLASS_SURFACE} text-zinc-400 hover:text-white hover:bg-white/[0.1] transition-colors cursor-pointer`}
          >
            <X size={15} />
          </button>
          ...
          {settingsMode ? (
            <>
              <div className="relative z-10 flex flex-col items-center pt-9 pb-5 px-6 border-b border-white/[0.08]">
                <div
                ...
                >
                  ...
                  <div className="relative w-full h-full rounded-full overflow-hidden bg-[#1e2a3a] ring-4 ring-[rgba(13,11,23,0.7)] flex items-center justify-center">
              ...
              <div className="relative z-10 p-3 border-t border-white/[0.08]">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-[#7c5cff] hover:bg-[#8f6bff] disabled:opacity-40 disabled:cursor-not-allowed text-white text-[13.5px] font-semibold shadow-[0_4px_18px_rgba(124,92,255,0.35)] transition-colors cursor-pointer"
                >
                  {savingSettings ? (
            ...
            <>
              <div className="relative z-10 flex flex-col items-center pt-8 pb-4 px-6 border-b border-white/[0.08]">
              ...
              <div className="relative z-10 px-4 pt-3 pb-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-9 pr-3 py-2.5 rounded-xl ${GLASS_SURFACE} text-[13.5px] text-white placeholder:text-zinc-600 outline-none focus:border-[#7c5cff]/50 transition-colors`}
                  />
                </div>
              </div>
                  ...
                  searchResults.map((u) => {
                    ...
                    return (
                      <button
                        ...
                        className="gm-row w-full flex items-center gap-3 px-3 py-2 rounded-2xl hover:bg-white/[0.05] cursor-pointer"
                      >
                        ...
                        <div
                          className={`shrink-0 w-5 h-5 rounded-full border flex items-center justify-center transition-colors ${selected
            ...
            <>
              <div className="relative z-10 flex flex-col items-center pt-9 pb-6 px-6 border-b border-white/[0.08]">
                <div className="relative w-24 h-24 mb-4">
                  <div className="gm-avatar-glow absolute -inset-[3px] rounded-full opacity-80 blur-[3px]" />

                  <div
                    className="gm-avatar relative w-full h-full rounded-full overflow-hidden bg-[#1e2a3a] ring-4 ring-[rgba(13,11,23,0.7)] flex items-center justify-center"
                    onClick={() =>
                  ...
                  {canManage && (
                    <>
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2.5 text-[12.5px] font-semibold text-zinc-300 hover:text-white hover:bg-white/[0.06] active:bg-white/[0.1] transition-colors cursor-pointer"
                      >
      ...
      {menuUid &&
        ...
        createPortal(
          <div
            className={`gm-row-menu fixed z-[240] w-[170px] rounded-xl ${GLASS_PANEL} overflow-hidden ${menuPos.openUp ? "open-up" : "open-down"
              }`}
            style={{
              left: menuPos.left,
              ...(menuPos.openUp
          ...
          >
            {isOwner && (
              <button
                ...
                className="w-full flex items-center gap-2.5 px-3.5 py-2.5 text-[13px] text-zinc-300 hover:bg-white/[0.06] transition-colors cursor-pointer"
              >
                {menuRow.role === "admin" ? (
                  <>
            ...
            {canKick(menuRow) && (
              <button
                ...
                className="w-full flex items-center gap-2.5 px-3.5 py-2.5 text-[13px] text-red-400 hover:bg-white/[0.06] transition-colors cursor-pointer"
              >
      ...
      {zoomUrl && (
        <div
          className="fixed inset-0 z-[230] flex items-center justify-center bg-black/85 [backdrop-filter:blur(8px)] [-webkit-backdrop-filter:blur(8px)]"
          onClick={() => setZoomUrl(null)}
        >
          <button
            onClick={() => setZoomUrl(null)}
            className={`absolute top-4 right-4 w-9 h-9 flex items-center justify-center rounded-xl ${GLASS_SURFACE} text-white hover:bg-white/[0.15] transition-colors`}
          >
            <X size={16} />
          </button>
