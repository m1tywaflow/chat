...
export default function CallWindow() {
    ...
    return createPortal(
        ...
        .call-overlay { animation: callFadeIn 0.2s ease-out; }
        .call-panel { animation: callFadeIn 0.28s ease-out; }
        .call-ring { animation: ringPulse 2.2s ease-out infinite; }
        .call-avatar { animation: avatarGlow 3.2s ease-in-out infinite; }
        .call-btn { transition: transform 0.15s ease, background 0.15s ease; }
        .call-btn:hover { transform: translateY(-2px); }
        .call-btn:active { transform: translateY(0) scale(0.94); }
      `}</style>
            ...
            <div className="call-overlay fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
                ...
                <div className="call-panel relative w-full max-w-md h-[85vh] max-h-[640px] overflow-hidden border border-white/[0.08] shadow-[0_0_80px_rgba(124,92,255,0.15)]">
                    ...
                    <div className="absolute inset-0 z-0">
                        <LiquidGlass
                            ...
                            style={{
                                background:
                                    "linear-gradient(180deg, rgba(18,17,31,0.6) 0%, rgba(7,6,13,0.72) 100%)",
                            }}
                        />
                    </div>
                    ...
                    <div className="relative z-10 w-full h-full flex flex-col pointer-events-none">
                        ...
                        <audio ref={remoteAudioRef} autoPlay className="pointer-events-auto" />
                            ...
                            {callType === "video" ? (
                                <>
                                    ...
                                    <video
                                        ...
                                        playsInline
                                        muted
                                        className="absolute bottom-4 right-4 w-28 h-40 object-cover border border-white/[0.12] bg-black/60 shadow-lg shadow-black/40 pointer-events-auto"
                                    />
                                </>
                            ) : (
                                <div className="flex flex-col items-center gap-5">
                        ...
                        <div className="flex-none flex items-center justify-center gap-4 px-6 py-7 border-t border-white/[0.06] bg-white/[0.02] pointer-events-auto">
                            <button
                                onClick={handleToggleMute}
                                title={isMuted ? "Unmute" : "Mute"}
                                className={`call-btn relative w-[52px] h-[52px] flex items-center justify-center border overflow-hidden ${isMuted
                                    ? "bg-white text-[#0d0b17] border-white"
                                    : "bg-white/[0.06] text-white border-white/[0.12] hover:bg-white/[0.1]"
                                    }`}
                            >
                            ...
                            {callType === "video" && (
                                <button
                                    onClick={handleToggleCamera}
                                    title={isCameraOff ? "Turn camera on" : "Turn camera off"}
                                    className={`call-btn relative w-[52px] h-[52px] flex items-center justify-center border overflow-hidden ${isCameraOff
                                        ? "bg-white text-[#0d0b17] border-white"
                                        : "bg-white/[0.06] text-white border-white/[0.12] hover:bg-white/[0.1]"
                                        }`}
                                >
                            ...
                            <button
                                onClick={handleEnd}
                                title="End call"
                                className="call-btn relative w-[52px] h-[52px] flex items-center justify-center bg-gradient-to-br from-red-500 to-red-600 text-white shadow-[0_0_28px_rgba(239,68,68,0.45)] hover:shadow-[0_0_36px_rgba(239,68,68,0.6)] overflow-hidden"
                            >
                                <PhoneOff size={19} />
                            </button>
                        </div>
