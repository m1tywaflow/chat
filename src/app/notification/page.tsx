...
export default function NotificationPage() {
  ...
  return (
    <div
      ...
      className={`group relative w-[380px] rounded-2xl bg-[#151D28]/95 backdrop-blur-xl text-white shadow-2xl shadow-black/50 border border-white/[0.08] p-3.5 flex items-center gap-3 cursor-pointer select-none transition-all duration-200 ease-out ${
        closing
